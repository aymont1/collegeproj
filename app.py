...
app = Flask(__name__)
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+mysqlconnector://{username}:{password}@{server}/testdb".format(username = "virtualmachine4", password = "Password4", server = "crazyoranges.mysql.database.azure.com")
db = SQLAlchemy(app)
...
#st1 = Students(id=1, firstname='Larisa', lastname='Moore', address='London', semesters= 1)
#st2 = Students(id=2, firstname='Matthew', lastname='Andrews', address='Birmingham', semesters= 2)
#st3 = Students(id=3, firstname='William', lastname='Thomas', address='Bournmouth', semesters= 3)
#st4 = Students(id=4, firstname='Frank', lastname='Richards', address='Wigan', semesters= 4)
#st5 = Students(id=5, firstname='Martin', lastname='Scotts', address='Leeds', semesters= 5)
#st6 = Students(id=6, firstname='Gerald', lastname='Smith', address='Liverpool', semesters= 1)
#st7 = Students(id=7, firstname='Mike', lastname='Freeds', address='Newcastle', semesters= 2)
#st8 = Students(id=8, firstname='Harry', lastname='Thompson', address='London', semesters= 4)
#st9 = Students(id=9, firstname= 'Blake', lastname='Gordan', address='Liverpool', semesters=1)
